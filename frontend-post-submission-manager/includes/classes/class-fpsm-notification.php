...
if (!class_exists('FPSM_Notification')) {
    class FPSM_Notification {
        ...
        public function trigger_admin_notification($insert_update_post_id, $form_row, $action) {
            ...
            if (empty($form_details['form']['post_status'][$post_status]['disable_post_submit_notification'])) {
                include(FPSM_PATH . '/includes/cores/post-submit-email-notification.php');
            }
        }
