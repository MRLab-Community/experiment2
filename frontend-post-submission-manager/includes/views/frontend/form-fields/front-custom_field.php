...
if (file_exists(FPSM_PATH . '/includes/views/frontend/form-fields/custom-field-types/' . $field_file)) {
    include(FPSM_PATH . '/includes/views/frontend/form-fields/custom-field-types/' . $field_file);
}
?>