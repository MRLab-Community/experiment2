...
<div class="fpsm-settings-each-section fpsm-display-none" data-tab="customize">
    ...
    <div class="fpsm-field-wrap">
        ...
        <div class="fpsm-field">
            <textarea name="form_details[customize][custom_css]"><?php echo (!empty($form_details['customize']['custom_css'])) ? $fpsm_library_obj->output_converting_br($form_details['customize']['custom_css']) : ''; ?></textarea>
        </div>
    </div>
    <div class="fpsm-field-wrap">
    ...
    <div class="fpsm-custom-enable-ref <?php echo (empty($form_details['customize']['form']['enable'])) ? 'fpsm-display-none' : ''; ?>">
        <div class="fpsm-field-wrap">
            <label><?php esc_html_e('Styling Options', 'frontend-post-submission-manager'); ?></label>
            <div class="fpsm-field" id="fpsm-custom-style-wrap">
                <div class="fpsm-customize-row">
                    <h4><?php esc_html_e('Body Customize', 'frontend-post-submission-manager'); ?></h4>
                    <div class="fpsm-field-wrap">
                        <label><?php esc_html_e('Body Text Color', 'frontend-post-submission-manager'); ?></label>
                        <div class="fpsm-field">
                    ...
                    <div class="fpsm-field-wrap">
                        ...
                        <div class="fpsm-field">
                            ...
                            <label style="margin-right: 20px;"><input type="radio"
                                                                      name="form_details[customize][form][background_type]"
                                                                      value="color"
                                                                      class="fpsm-toggle-trigger" data-toggle-class="fpsm-background-type-ref" <?php checked($selected_background_type, 'color'); ?>/><?php esc_html_e('Color', 'frontend-post-submission-manager'); ?></label>
                ...
                <div class="fpsm-customize-row fpsm-label-background-ref <?php echo (!in_array($form_template, $label_background_templates)) ? 'fpsm-display-none' : ''; ?>">
                    <h4><?php esc_html_e('Field Labels', 'frontend-post-submission-manager'); ?></h4>
                    <div class="fpsm-field-wrap">
                ...
                <div class="fpsm-customize-row">
                    <h4><?php esc_html_e('Buttons', 'frontend-post-submission-manager'); ?></h4>
                    <div class="fpsm-field-wrap">
                ...
                <div class="fpsm-customize-row">
                    <h4><?php esc_html_e('Radio Button', 'frontend-post-submission-manager'); ?></h4>
                    <div class="fpsm-field-wrap">
                ...
                <div class="fpsm-customize-row">
                    <h4><?php esc_html_e('Checkboxes', 'frontend-post-submission-manager'); ?></h4>
                    <div class="fpsm-field-wrap">
