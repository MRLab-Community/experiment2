...
<div class="fpsm-settings-each-section fpsm-display-none fpsm-clearfix" data-tab="login">
    ...
    <div class="fpsm-login-type-ref <?php echo ($selected_login_type != 'login_form') ? 'fpsm-display-none' : ''; ?>" data-toggle-ref="login_form">
        <div class="fpsm-field-wrap">
            <label><?php esc_html_e('Login Form Title', 'frontend-post-submission-manager'); ?></label>
            <div class="fpsm-field">
        ...
        <div class="fpsm-field-wrap">
            <label><?php esc_html_e('Login Note', 'frontend-post-submission-manager'); ?></label>
            <div class="fpsm-field">
                <textarea name="form_details[login][login_note]"> <?php echo (!empty($login_form_settings['login_note'])) ? $fpsm_library_obj->sanitize_html($login_form_settings['login_note']) : ''; ?></textarea>
            </div>
        </div>
        <div class="fpsm-field-wrap">
