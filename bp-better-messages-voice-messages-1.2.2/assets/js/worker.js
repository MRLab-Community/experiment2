const { CREATE_JOB, CLEANUP, FINISH_JOB, INIT } = {
    INIT: 'INIT',
...
function initModule( wasmURL ){
    ...
    // Memory management
                ...
                var STATIC_BASE = 1024,
                    ...
                    STACKTOP = STACK_BASE,
                    STACK_MAX = 5342176,
                    DYNAMIC_BASE = 5342176,
                    DYNAMICTOP_PTR = 99104;
    ...
    // ASM_LIBRARY EXTERN PRIMITIVES: Int8Array,Int32Array
                ...
                var asmLibraryArg = { "___assert_fail": ___assert_fail, "___lock": ___lock, "___unlock": ___unlock, "___wasi_fd_close": ___wasi_fd_close, "___wasi_fd_seek": ___wasi_fd_seek, "___wasi_fd_write": ___wasi_fd_write, "__memory_base": 1024, "__table_base": 0, "_emscripten_get_heap_size": _emscripten_get_heap_size, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_resize_heap": _emscripten_resize_heap, "_exit": _exit, "_fd_close": _fd_close, "_fd_seek": _fd_seek, "_fd_write": _fd_write, "_llvm_cos_f64": _llvm_cos_f64, "_llvm_log10_f32": _llvm_log10_f32, "_llvm_log10_f64": _llvm_log10_f64, "_llvm_sin_f64": _llvm_sin_f64, "abort": abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "demangle": demangle, "demangleAll": demangleAll, "emscripten_realloc_buffer": emscripten_realloc_buffer, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "getTempRet0": getTempRet0, "jsStackTrace": jsStackTrace, "memory": wasmMemory, "nullFunc_ii": nullFunc_ii, "nullFunc_iidiiii": nullFunc_iidiiii, "nullFunc_iii": nullFunc_iii, "nullFunc_iiifii": nullFunc_iiifii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_iiiii": nullFunc_iiiii, "nullFunc_jiji": nullFunc_jiji, "nullFunc_vii": nullFunc_vii, "nullFunc_viiii": nullFunc_viiii, "setTempRet0": setTempRet0, "stackTrace": stackTrace, "table": wasmTable, "tempDoublePtr": tempDoublePtr };
    // EMSCRIPTEN_START_ASM
                ...
                var _eencode = Module["_eencode"] = function() {
                    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                    return Module["asm"]["_eencode"].apply(null, arguments)
                };
                ...
                var _encoder_create = Module["_encoder_create"] = function() {
                    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                    return Module["asm"]["_encoder_create"].apply(null, arguments)
                };

                var _encoder_destroy = Module["_encoder_destroy"] = function() {
                    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                    return Module["asm"]["_encoder_destroy"].apply(null, arguments)
                };

                var _encoder_flush = Module["_encoder_flush"] = function() {
                    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
                    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
                    return Module["asm"]["_encoder_flush"].apply(null, arguments)
                };
...
async function buildMp3(payload, meta, options) {
    ...
    try {
        ...
        //console.log('Encoder created success');
        /**
         ...
         */
        //console.log('Allocating memory for left, right PCM data, and encoded');
         ...
         */
        //console.log('Posting message with MP3 buffer back down to main thread');
...
onmessage = ({ data }) => {
    ...
    switch (type) {
        ...
        default:
            //console.log('Unknown message received on worker');
            break;
    }
};
